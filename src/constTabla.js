...
function facDetails(xml, cantArch) {
    ...
    // Obtencion de codigo de usuario GIA
    let codUsuario = document.getElementById('usuario').value

    if (codUsuario === "") {
        alert("Ingrese su usuario de GIA")
        return
    } else {
        cabezales.USUCOD = codUsuario
    }

    // Obtencion dato Fecha de ingreso (fecha del día)
